    ...
    <section id="calculator" className="py-28 bg-transparent relative z-10">
      <div className="container mx-auto px-6">
        <motion.div
          ...
          className="bg-gray-900/40 backdrop-blur-md border border-gray-800 
                     rounded-2xl p-10 shadow-xl max-w-3xl mx-auto relative overflow-hidden"
        >
          ...
          <div className="text-center mt-12">
            ...
            <motion.p
              key={displayedMinLoss + displayedMaxLoss}
